import type { User, PermissionAction, PermissionResource } from "@/types/auth"
...
export class PermissionChecker {
  ...
  hasPermission(permission: string): boolean {
    ...
    return this.user.roles.some((role) => role.permissions.some((p) => `${p.resource}:${p.action}` === permission))
  }
